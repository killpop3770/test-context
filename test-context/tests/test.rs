...
// use test_context_macros::my_wrapper;
...
// #[test_context_rstest_redo(MyContext)]
// #[rstest]
// #[case("Hello world!")]
// #[tokio::test]
// async fn test_rstest_with(#[case] _value: String) {
...
// #[case(2, 2, 4)]
// #[tokio::test]
// async fn test_addition(#[case] a: i32, #[case] b: i32, #[case] expected: i32, ctx: &mut MyContext) {
//     // println!("Вычисляем: {} + {} = {}", a, b, expected);
